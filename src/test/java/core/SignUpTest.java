...
public class SignUpTest {
  ...
  public void beforeMethod() throws IOException {
	  Browsers.setWebDriver(BasePage.in_browser);
	  Browsers.driver.get(BasePage.url);}
  ...
  public void test_04_verify_content_date() throws IOException {
	  ...
	  Assert.assertEquals(todays_day, "February 11, 2017 ");} 
  ...
  @Test
  public void test_11_verify_submit_form() throws IOException, InterruptedException {
	  boolean title = ConfirmationPage.verify_submit_form (BasePage.fname,BasePage.lname,BasePage.email,BasePage.phone);
  ...
  public void test_13_verify_error_handling_face_last_name() throws IOException, InterruptedException {
	  Browsers.driver.findElement(By.id("id_fname")).sendKeys(BasePage.fname);
  ...
  public void test_14_verify_error_handling_email() throws IOException, InterruptedException {
	  Browsers.driver.findElement(By.id("id_fname")).sendKeys(BasePage.fname);
	  Browsers.driver.findElement(By.id("id_lname")).sendKeys(BasePage.lname);
  ...
  public void test_15_verify_error_handling_phone_number() throws IOException, InterruptedException {
	  Browsers.driver.findElement(By.id("id_fname")).sendKeys(BasePage.fname);
	  Browsers.driver.findElement(By.id("id_lname")).sendKeys(BasePage.lname);
	  Browsers.driver.findElement(By.id("id_email")).sendKeys(BasePage.email);
	  String id_phone = SignUpPage.verify_error_handling("id_phone");
	  Assert.assertEquals(id_phone, "Please enter Phone Number");} 

  @Test
  public void test_16_verify_confirmation_page() throws IOException, InterruptedException {
	  ConfirmationPage.verify_confirmation(BasePage.fname,BasePage.lname,BasePage.email,BasePage.phone);
	  String title = BasePage.verify_page_application_title("id_f_title");
	  Assert.assertEquals(title, "Confirmation");}  
